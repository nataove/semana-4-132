...
.about-us__reason{
    border: 4px dashed var(--main-color3);
    margin: 0;
    padding: 4rem 2rem;
    position: relative;
    width: 80%;
...
.about-us__reason:nth-child(2n + 1) {
...
.about-us__reason:nth-child(2n) .number{
    left: 0;
}

.about-us__reason:nth-child(2n + 1) .number{
    right: 0;
    transform: translate(50%, -50%);
}
